/** ---------------------------------------------------------------------------------------------------------------- **
 ...
 /** ---                                       -----------------------------                                     --- **
 /** ---                                                                                                         --- **
 /** ---        VERSION 1.4.0: 14.09.2018 : NDU                                                                  --- **
 /** ---        --------------------------------                                                                 --- **
 /** ---            - L'élément en cours de construction est autobindé à la fonction d'éxécution dans            --- **
 /** ---            strBuildJSON.functions                                                                       --- **
 /** ---            - L'élément est toujours pusher en tant que paramètres du reste en cas de bind forcé         --- **
 /** ---            ce qui assure la rétro-compatibilité                                                         --- **
 /** ---                                                                                                         --- **
        ...
        if(structure.functions !== undefined && Array.isArray(structure.functions)){
            for(var fn = 0; fn < structure.functions.length; fn++){
                if(typeof(structure.functions[fn].function) === 'function'){
                    ...
                    structure.functions[fn].function.apply(element, structure.functions[fn].args);
                }
            }
        }
